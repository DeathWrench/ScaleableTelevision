...
namespace ScaleableTV
{
    public class ConfigManager
    {
        ...
        private ConfigManager(ConfigFile cfg)
        {
            ...
            //tvPositionY = cfg.Bind("Options", "TV Position Y", 1.1f, "Z Coordinates\n Front/Back\n Make sure you put a ''f'' at the end of the number.");
            configBiggerInteractRadius = cfg.Bind("Accessibility", "Bigger Interact Radius", true, "You can interact with the TV by just looking at it if you're close enough, rather than only the bottom right corner."         // Description
            );
        }
    }
}